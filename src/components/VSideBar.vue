...
<template>
  ...
  <ul class="navbar__menu">
    <li class="navbar__item list-none"
    
    >
      <RouterLink to="/" class="navbar__link"><Icon icon="mdi-home" @click="router.push('/')" x2/><span>Home</span></RouterLink>
    </li>
    <li class="navbar__item list-none">
      <RouterLink to="about" class="navbar__link"><Icon icon="mdi-account" x2/><span>About</span></RouterLink>        
    </li>
    <li class="navbar__item list-none">
      <RouterLink to="contact" class="navbar__link"><Icon icon="mdi-email" x2/><span>Contact</span></RouterLink>        
    </li>
    <li class="navbar__item list-none"
    
    >
      <RouterLink to="portfolio"  class="navbar__link"><Icon icon="mdi-briefcase" x2/><span>Portfolio</span></RouterLink>        
    </li>
    <li class="navbar__item list-none">
      <RouterLink to="messages" class="navbar__link"><Icon icon="mdi-message" x2/><span>Messages</span></RouterLink>        
    </li>
    <li class="navbar__item list-none">
      <RouterLink to="video" class="navbar__link"><Icon icon="mdi-video" x2/><span>Video</span></RouterLink>        
    </li>
  </ul>
</nav>
